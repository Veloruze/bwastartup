...
func (h *transactionHandler) GetUserTransactions(c *gin.Context) {
	...
	response := helper.APIResponse("Transaction detail", http.StatusOK, "success", transaction.FormatUserTransactions(transactions))
	c.JSON(http.StatusOK, response)
}
...
func (h *transactionHandler) CreateTransaction(c *gin.Context) {
	...
	response := helper.APIResponse("Success to create transaction", http.StatusOK, "successs", transaction.FormatTransaction(newTransaction))
	c.JSON(http.StatusOK, response)
...
func (h *transactionHandler) GetNotification(c *gin.Context) {
	...
	err := c.ShouldBindJSON(&input)
	if err != nil {
		response := helper.APIResponse("Failed to get process notification", http.StatusBadRequest, "error", nil)
		c.JSON(http.StatusBadRequest, response)
		return
	}
