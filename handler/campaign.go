...
func (h *campaignHandler) CreateCampaign(c *gin.Context) {
	...
	response := helper.APIResponse("Success to create campaign", http.StatusOK, "successs", campaign.FormatCampaign(newCampaign))
	c.JSON(http.StatusOK, response)
}
...
func (h *campaignHandler) UpdateCampaign(c *gin.Context) {
	...
	response := helper.APIResponse("Success to update campaign", http.StatusOK, "successs", campaign.FormatCampaign(updatedCampaign))
	c.JSON(http.StatusOK, response)
}
